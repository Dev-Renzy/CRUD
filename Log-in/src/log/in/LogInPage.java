...
public class LogInPage extends javax.swing.JFrame {
    ...
    private void jButtonLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLogActionPerformed
        ...
        UserDetails dha = new UserDetails();
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from renzy where firstname = (" + "'" + userName + "'" + ");");

            while (rs.next()) {
                name = rs.getString("firstname");
                pass = rs.getString("verifypassword");
            }
            if (userName.equals("") && pass.equals("")) {
                JOptionPane.showMessageDialog(null, "The field is empty!");
                this.setVisible(true);
            } else {
                if (userName.equals(name) && pass.equals(passcode)) {
                    this.dispose();
                    dha.name = userName;
                    dha.setVisible(true);
                }
                if (!userName.equals(name)) {
                    JOptionPane.showMessageDialog(null, "You've entered an invalid username");
                } else if (!pass.equals(passcode)) {
                    JOptionPane.showMessageDialog(null, "You've entered an invalid password");
                }
            }
