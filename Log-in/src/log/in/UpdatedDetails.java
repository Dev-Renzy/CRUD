...
public class UpdatedDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Updated Account Settings");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ResultSet rs = st.executeQuery("select * from renzy where firstname=(" + "'" + currentFname + "'" + ");");
            while (rs.next()) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (dialogResult == JOptionPane.YES_OPTION) {
            try {
                ...
                st.executeUpdate("delete from renzy where firstname=(" + "'" + currentFname + "'" + ");");
